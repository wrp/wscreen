...
static void FreeCanvas( struct canvas * );
...
static void cv_winid_fn( struct event *, char * );
#ifdef MAPKEYS
...
#endif
static void FreePerp( struct canvas * );
static struct canvas *AddPerp( struct canvas * );

...
extern void  eexit( int );
extern void  Detach( int );
extern void  Hangup( void );
extern void  Kill( int, int );
#ifdef USEVARARGS
extern void  Msg( int, char *, ... ) __attribute__((format(printf, 2, 3)));
extern void  Panic( int, char *, ... ) __attribute__((format(printf, 2, 3)));
#else
extern void  Msg(  );
extern void  Panic(  );
#endif
...
extern void  display_wlist( int, int, struct win * );
...
extern void  SendCmdMessage( char *, char *, char ** );
...
#ifdef USEVARARGS
extern void  LMsg( int, char *, ... ) __attribute__((format(printf, 2, 3)));
#else
extern void  LMsg(  );
#endif
